...
public:
    ...
    ExampleApplication() : Screen(Vector2i(1024, 768), "NanoGUI Test") {
        inc_ref();
        MenuBar *m_menubar = new MenuBar(this, "CoolMenu");
        ...
        window->set_position(Vector2i(15, 25));
        window->set_layout(new GroupLayout());
        Widget *window_panel = window->button_panel();
        Button *close = new Button(window_panel, "X");
        close->set_callback([window] { std::cout << "closing!" << std::endl; window->dispose(); });
        ...
        window->set_position(Vector2i(200, 25));
        window->set_layout(new GroupLayout());
        ...
        image_window->set_position(Vector2i(710, 25));
        ...
        window->set_position(Vector2i(425,25));
        window->set_layout(new GroupLayout());
        ...
        window->set_layout(new GroupLayout());
        window->set_position(Vector2i(15, 550));

        VScrollPanel *vscrollta = new VScrollPanel(window);
        vscrollta->set_fixed_size(Vector2i(360, 80));
        auto text_area = new TextArea(vscrollta);
        text_area->set_font_size(16);
        string history = "The written history of Mexico spans more than three millennia.\n First populated more than 13,000 years ago,[1] central and southern Mexico (termed Mesoamerica) saw the rise and fall of complex indigenous civilizations.\n Mexico would later develop into a unique multicultural society.\n Mesoamerican civilizations developed glyphic writing systems, recording the political history of conquests and rulers.\n Mesoamerican history prior to European arrival is called the prehispanic era or the pre-Columbian era.\n Following Mexico's independence from the Spanish Empire in 1821, political turmoil wracked the nation.\n France, with the help of Mexican conservatives, seized control in the 1860s during the Second Mexican Empire but was later defeated.\n Quiet prosperous growth was characteristic in the late 19th century but the Mexican Revolution in 1910 brought a bitter civil war.\n With calm restored in the 1920s, economic growth was steady while population growth was rapid.\n\n-Wikipedia\n";
        text_area->append(history);
